...
class SubTime:
    ...
    perturbation_variable: Optional[str] = None    # "dT" or None
...
class EqualityBlock:
    ...
    id: str
    source_model: str = ""             # e.g. "model.dynamics.reentry"
...
class InequalityBlock:
    ...
    id: str
    source_model: str = ""             # e.g. "model.inequalities.alpha_bounds"
...
class ObjectiveTerm:
    ...
    type: str = ""                     # "integral_quadratic" | "linear" | "scalar_quadratic" | "integral_linear"
    grid: str = ""
    range: Any = None                  # concrete [start, end] list, never "all"
    expr: str = ""
